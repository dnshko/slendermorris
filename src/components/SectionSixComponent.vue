<template>
  <div
    class="row-fluid-wrapper row-depth-1 row-number-24 dnd-section dnd_area-row-5-max-width-section-centering dnd_area-row-5-padding"
  >
    <div class="row-fluid">
      <div
      ...
      >
        <div class="row-fluid-wrapper row-depth-1 row-number-25 dnd-row">
          <div class="row-fluid">
            ...
            >
              <div
                id="hs_cos_wrapper_module_1634620231066"
              ...
              >
                <span
                  id="hs_cos_wrapper_module_1634620231066_"
                ...
                >
                  <h2 style="font-size: 36px">
                    <a
                      ...
                      target="_blank"
                      id="__hsNewLink"
                      ><span style="color: #000000">BLIND</span>
                      <span style="color: #000000">GUIDE (2 of 3)</span></a
                    >
                  </h2>
                </span>
              </div>
        ...
        <div class="row-fluid-wrapper row-depth-1 row-number-26 dnd-row">
          <div class="row-fluid">
            ...
            >
              <div
                id="hs_cos_wrapper_widget_1634619341550"
